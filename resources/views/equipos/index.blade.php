                            ...
                            @if($yaEstaEnEquipo && $miEquipo)
                                ...
                                <div class="flex flex-col items-end gap-2">
                                    ...
                                    <a href="{{ route('equipos.show', $miEquipo) }}" 
                                       class="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-6 py-3 rounded-lg transition duration-200">
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow duration-200">
                            <div class="p-6">
                                ...
                                <a href="{{ route('equipos.show', $equipo) }}" 
                                   class="block w-full text-center bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-2 px-4 rounded-lg transition duration-200">
                                    Ver Detalle
                                </a>
                            </div>
                        </div>
            ...
            @else
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-12 text-center">
                        ...
                        <h3 class="mt-4 text-lg font-medium text-gray-900">No hay equipos aún</h3>
